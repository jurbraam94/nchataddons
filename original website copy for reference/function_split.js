...
loadLob = function (p) {
    hideAll();
    $.post('system/pages/' + p, {}, function (response) {
...
loadFirst = function () {
    if (loadPage != '') {
        $.post(loadPage, {}, function (response) {
            $('#page_wrapper').html(response);
            selectIt();
        });
    }
...
updateSession = function () {
    if (!insideChat() && logged == 1) {
        $.post('system/action/update_session.php', {}, function (response) {
            if (response == 0) {
                location.reload();
            }
        });
...
getLanguage = function () {
    $.post('system/box/language.php', {}, function (response) {
...
showRules = function () {
    $.post('system/box/terms.php', {}, function (response) {
        overModal(response, 500);
    });
}
showPrivacy = function () {
    $.post('system/box/privacy.php', {}, function (response) {
...
$(document).ready(function () {
    ...
    $(document).on('click', '.bswitch', function () {
        ...
        if (cval == 1) {
            ...
            $(this).find('.bball').switchClass("onball", "offball", 100, function () {
                window[callback]();
            });
        } else if (cval == 0) {
            $(this).attr('data', 1);
            $(this).switchClass("offswitch", "onswitch", 100);
            $(this).find('.bball').switchClass("offball", "onball", 100, function () {
                window[callback]();
            });
        }
    });
